...
export default function Navbar({ locale, currentPath = '' }: NavbarProps) {
    ...
    return (
        ...
        >
            ...
            {/* Mobile menu */}
            {mobileOpen && (
                <div className="fixed inset-x-0 top-[76px] bottom-0 z-[200] bg-white overflow-y-auto border-t border-gray-200 shadow-[0_8px_32px_rgba(0,0,0,0.12)] lg:hidden animate-in slide-in-from-top-2" role="dialog" aria-label="Menú móvil">
